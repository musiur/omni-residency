...
const NearbyPlaces = () => {
  return (
    <section className="container flex flex-col-reverse min-[900px]:flex-row items-stretch items-center gap-[40px]" id="nearby-attractions">
      ...
      <div className="flex-[0.6] grid grid-cols-1 min-[480px]:grid-cols-2 gap-[24px]">
        {placesCardData.map((item) => {
          const { id, image, name, distance, intro } = item;
          return (
            <div
            ...
            >
              ...
              <div className="w-full bg-white/30 backdrop-blur p-[16px] flex flex-col gap-[4px]">
                ...
                <p className="text-gray-100 font-light">{intro}</p>
              </div>
            </div>
          );
        })}
